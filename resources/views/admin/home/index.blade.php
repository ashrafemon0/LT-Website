  ...
  <thead>
    <tr>
      ...
      <th scope="col" width="15%">Long Description</th>
        <th scope="col" width="15%">Big Image</th>
        <th scope="col" width="15%">Small Image</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> {{ $about->long_dis }} </td>
        <td><img  src="{{ asset('$about->big_img') }}" style="height:40px; width:70px;" ></td>
        <td> <img src="{{ asset('$about->small_img') }}" style="height:40px; width:70px;" ></td>
