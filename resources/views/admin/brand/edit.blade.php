...
@section('admin')
  ...
  <div class="form-group">
    ...
    <input type="text" name="brand_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $brands->brand_name }}">
      <label for="exampleInputEmail1">Update Brand Description</label>
      <input type="text" name="brand_des" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $brands->brand_des }}">
          @error('brand_name')
